...
while(i<pivotIndex && j>pivotIndex){
    //here we just checking if the element is smaller then the pivot the increment i
     ...
     //here once more we will check whether i and j crossed the pivot or not (it's just for confirmation we will get correct answer even if we don't use if over here, but sometimes we might get wrong answer that's why for safer side we are using the this if condition here  )
